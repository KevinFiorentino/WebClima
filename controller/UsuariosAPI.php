...
class UsuariosAPI {    
    ...
    function insertUsuario(){
        ...
        if (empty($objArr)){
            ...
            $usuariosDao = new UsuariosDao();     
            $usuariosDao->insertUsuario($obj->user, $obj->pass, $obj->idCiudad);
    ...
    function updateUsuario(){
        ...
        else if( isset($obj->idUsuario) && isset($obj->user) && isset($obj->pass) && isset($obj->idCiudad) ) {
            $usuariosDao = new UsuariosDao();     
            $usuariosDao->updateUsuario($obj->idUsuario, $obj->user, $obj->pass, $obj->idCiudad);
            $this->response(200,"success","new record added");                             
        }
        else{
             $this->response(422,"error","The property is not defined");
